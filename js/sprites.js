...
const spriteCache={};
const SPRITE_ANIMS={idle:{frames:6,rate:10},walk:{frames:8,rate:4},attack_light:{frames:6,rate:3},attack_heavy:{frames:6,rate:5},hurt:{frames:3,rate:6},jump:{frames:6,rate:5},block:{frames:4,rate:6},dash:{frames:6,rate:2},attack_ult:{frames:8,rate:6},attack_throw:{frames:6,rate:4},ko:{frames:4,rate:5},knockdown:{frames:6,rate:4},grabbed:{frames:6,rate:4},thrown:{frames:6,rate:4},kick_light:{frames:6,rate:3},kick_heavy:{frames:6,rate:5}};
